    ...
    def collison(self, axis):
        for sprite in self.collision_sprites:
            if sprite.rect.colliderect(self.collision_rect):
                if axis == 'horizontal':
                    if self.collision_rect.left <= sprite.rect.right and self.old_rect.left >= sprite.old_rect.right:
                        self.collision_rect.left = sprite.rect.right
                    if self.collision_rect.right >= sprite.rect.left and self.old_rect.right <= sprite.old_rect.left:
